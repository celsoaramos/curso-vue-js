		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Armazenar dados ?">
					<span class="mr-4"><input type="radio" value="Sim" v-model="usuario.armazenarDados"> Sim</span>
					<span class="mr-4"><input type="radio" value="Não" v-model="usuario.armazenarDados"> Não</span>
				</Rotulo>
