<template>
    <div class="container">
        ...
        <p>Nome é <strong>{{ nome }}</strong>
        <p>Idade é <strong>{{ idade }}</strong></p>
        <button @click="alterarNome">Alterar nome</button>
        <hr>
        <div class="componentes">
             <!-- 
                 :nome é para passar o nome do componente pai (Usuario.vue) para o filhoe UsuarioInfo.vue
                 @nomeMudou é para o filho passar informação para o pai.
              -->
            <app-usuario-info 
                    :nome="nome" 
                    :idade="idade"
